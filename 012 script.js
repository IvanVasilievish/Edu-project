...
// console.log(personalMovieDB);
// _______________________Решение 2 к практике 2 (через while)________________________

// let successfulEntries = 0;
// while (successfulEntries < 2) {
//     const a = prompt ('Один из последних просмотренных фильмов?',''),
//           b = prompt ('На сколько оцените его?','');
//     if (a != null && b != null && a != '' & b != '' && a.length <50) {
//         personalMovieDB.movies[a] = b;
//         console.log('Done_2');
//         successfulEntries++;    
// } else {console.log('Error_2');

// }
// }

// console.log(personalMovieDB);
// _______________________Решение 3 к практике 2 (через do...while)________________________
// let count = 0;
// do {
//     const a = prompt ('Один из последних просмотренных фильмов?',''),
//           b = prompt ('На сколько оцените его?','');
